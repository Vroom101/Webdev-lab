...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $rationNumber = htmlspecialchars(trim($_POST["rationNumber"] ?? ''));
    $familySize = htmlspecialchars(trim($_POST["familySize"] ?? ''));
    ...
    $errors[] = "No direct script access allowed. Please submit the form via POST method.";
}
...
<head>
    ...
    <title>POST Registration Result</title>
...
<body>
    ...
    <div class="container-card">
        <div class="header-section" style="margin-bottom: 1rem;">
            <h2>Processor Mode <span class="badge">$_POST</span></h2>
        </div>
